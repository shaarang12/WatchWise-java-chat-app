...
public class Java_Chat_App extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        setTitle("Chat Application by Shaarang Prabhudesai");
        ...
        jLabel8.setText(" Java Chat: Connect Anywhere");
...
void seticon()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Java_Chat_App.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              Java_Chat_App root = new Java_Chat_App();  //initializing the main gui
